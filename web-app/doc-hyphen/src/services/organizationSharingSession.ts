...
export const fetchOrganizationLinks = (token?: string | null): Promise<OrganizationSharingSessionLinkBasicDto[] | ResponseError> =>
    executeRequest(() =>
...
export const fetchOrganizationLinksByOrganization = (organizationId: string, token?: string | null): Promise<OrganizationSharingSessionLinkBasicDto[] | ResponseError> =>
    executeRequest(() =>
...
export const createOrganizationLink = (requestingOrganizationId: string, requestedOrganizationId: string, message?: string, token?: string | null): Promise<OrganizationSharingSessionLinkBasicDto | ResponseError> =>
    executeRequest(() =>
...
export const acceptOrRejectOrganizationLink = (linkId: string, status: string, rejectionReason?: string, token?: string | null): Promise<OrganizationSharingSessionLinkBasicDto | ResponseError> =>
    executeRequest(() =>
