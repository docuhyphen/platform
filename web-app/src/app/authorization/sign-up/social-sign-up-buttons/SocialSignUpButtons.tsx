...
import {useSocialSignUpButtonsStyles} from "./SocialSignUpButtonsStyles.tsx";

const startOAuthSignUp = (provider: "GOOGLE" | "MICROSOFT") =>
{
    const apiBaseUrl = getApiBaseUrl();
    window.location.href = `${apiBaseUrl}/auth/oauth/${provider}/authorize?flow=signup`;
};

const GoogleBrandMark = () => (
    <svg
        id={"sign-up-google-brand-mark"}
        viewBox={"0 0 18 18"}
        aria-hidden={"true"}>
        <path
            fill={"#4285F4"}
...
const MicrosoftBrandMark = () => (
    <svg
        id={"sign-up-microsoft-brand-mark"}
        viewBox={"0 0 18 18"}
        aria-hidden={"true"}>
        <rect
            fill={"#F25022"}
...
{
    const styles = useSocialSignUpButtonsStyles();

    return (
        <div
            id={"social-sign-up-buttons"}
            ...
            <Button
                ...
                icon={
                    <span
                        id={"sign-up-microsoft-icon"}
                        className={styles.providerIcon}>
                        <MicrosoftBrandMark/>
                    </span>
                }
                onClick={() => startOAuthSignUp("MICROSOFT")}
