...
const auditEventTypeLabels: Record<string, string> = {
    ...
    "organization.trust.requested": "Trusted Organization requested",
    "organization.trust.rerequested": "Trusted Organization requested again",
    "organization.trust.accepted": "Trusted Organization accepted",
    "organization.trust.rejected": "Trusted Organization rejected",
    "organization.trust.withdrawn": "Trusted Organization request withdrawn",
    "organization.trust.expired": "Trusted Organization request expired",
    "organization.trust.suspended": "Trusted Organization suspended",
    "organization.trust.resumed": "Trusted Organization resumed",
    "organization.trust.ended": "Trusted Organization ended",
    "organization.trust.policy.updated": "Trusted Organization policy updated",
    "organization.trust.published_group.listed": "Trusted Organization published groups viewed",
    "organization.trust.published_group.denied": "Trusted Organization published groups denied",
    "organization.trust.identity_resolution.allowed": "Trusted Organization member verified",
    "organization.trust.identity_resolution.denied": "Trusted Organization member verification denied",
    "organization.trust.identity_resolution.expired": "Trusted Organization member verification expired",
    "organization.trust.identity_resolution.consumed": "Trusted Organization member verification used",
    "organization.trust.identity_resolution.replay_denied": "Trusted Organization member verification reuse denied",
    "organization.trust.recipient_validation.allowed": "Trusted Organization recipient validation allowed",
    "organization.trust.recipient_validation.denied": "Trusted Organization recipient validation denied",
    "organization.trust.acceptance.allowed": "Trusted Organization acceptance allowed",
    "organization.trust.acceptance.denied": "Trusted Organization acceptance denied",
