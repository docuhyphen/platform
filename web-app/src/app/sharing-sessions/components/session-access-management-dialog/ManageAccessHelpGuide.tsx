    ...
    return (
        <div className={styles.container}>
            <Text size={200} className={styles.intro}>
                This guide explains how sharing-session access works, including roles, constraints,
            ...
            <Accordion multiple collapsible defaultOpenItems={['roles']}>
                    ...
                    <AccordionPanel>
                        <div className={styles.section}>
                            <Text size={200} className={styles.sectionIntro}>
                                Each person in a session is assigned a role that determines what they can do.
                                The session creator is always the <strong>Owner</strong>.
                            </Text>
                            ...
                            <div className={styles.roleCard}>
                                ...
                                <Text size={200}>
                                    Full control over the session. Can manage access, edit settings, add/remove
                                    documents, and end the session. This role is structural and cannot be assigned
                                    or revoked.
                                </Text>
                            </div>
                            ...
                            <div className={styles.roleCard}>
                                ...
                                <Text size={200}>
                                    Can add, update, upload, and manage documents within the session. Editors
                                    have broad document-level access but cannot manage session access or settings.
                                </Text>
                            </div>
                            ...
                            <div className={styles.roleCard}>
                                ...
                                <Text size={200}>
                                    Read-only access to session documents. Viewers can browse and preview documents
                    ...
                    <AccordionPanel>
                        <div className={styles.section}>
                            ...
                            <div className={styles.constraintCard}>
                                ...
                                <Text size={200}>
                                    Prevents the participant from sharing or forwarding the session link
                                    to others.
                                </Text>
                            </div>
                            ...
                            <div className={styles.constraintCard}>
                                ...
                                <Text size={200}>
                                    ...
                                    accessing session documents, adding an extra layer of security.
                                </Text>
                            </div>
                            ...
                            <div className={styles.constraintCard}>
                                ...
                                <Text size={200}>
                                    Limits the number of times a participant can view the session documents.
                ...
                <AccordionItem value="permissions">
                    ...
                    <AccordionPanel>
                        <div className={styles.section}>
                            <Text size={200} className={styles.sectionIntro}>
                                Document permissions are session-wide settings that control what actions
                            ...
                            <div className={styles.constraintCard}>
                                ...
                                <Text size={200}>
                                    When enabled, participants can remove documents from the session.
                                </Text>
                            </div>
                            ...
                            <div className={styles.constraintCard}>
                                ...
                                <Text size={200}>
                                    When enabled, participants can download all session documents as a
                                    single zip archive.
                                </Text>
                            </div>
                ...
                <AccordionItem value="settings">
                    <AccordionHeader>Session settings</AccordionHeader>
                    <AccordionPanel>
                        <div className={styles.section}>
                            <div className={styles.constraintCard}>
                                ...
                                <Text size={200}>
                                    ...
                                    the session. When disabled, the recipient can use a one-time email
                ...
                <AccordionItem value="summary">
                    ...
                    <AccordionPanel>
                        <div className={styles.section}>
                            <Text size={200}>
                                The Summary tab shows all people involved in the session: the <strong>Requester</strong> (who
                                initiated the session), the <strong>Primary recipient</strong> (the main person the
                                session was shared with), and any additional <strong>Participants</strong> (users or
            ...
            <Text size={200} className={styles.footerNote}>
                ...
                (your own access and the session owner) cannot be modified or revoked.
            </Text>
        </div>
    );
};
