# Demo Sharing Session Generator
...
- `apis/demo-sharing-session-generator.html`
- `apis/demo-sharing-session-generator.js`

## Usage

1. Start your API server on `http://localhost:8080` (or change Base URL in the page).
2. Open `apis/demo-sharing-session-generator.html` in your browser.
...
- Session payload shape follows examples in `apis/sharing-session-api.http`.
