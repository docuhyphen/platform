...
class PlatformUserSubscriptionTrialResourceContractTest
{
    @Test
    fun `user trial endpoints use resource based paths and verbs`()
    {
        val resource = PlatformUserSubscriptionTrialResource::class.java
        assertEquals(
