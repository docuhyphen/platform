...
{
    /** All access entries (any status) for a sharing session, newest grant first. */
    fun getSessionAccessView(sessionId: UUID): List<SessionAccessEntryDto> =
        shareRepository.findAllByResource(ResourceType.SHARING_SESSION, sessionId)
