...
object InformationRequestErrorCatalog
{
    ...
    const val EVIDENCE_NOT_COLLECTED = "INFORMATION_REQUEST_EVIDENCE_NOT_COLLECTED"

    const val EVIDENCE_ARTIFACT_INACTIVE = "INFORMATION_REQUEST_EVIDENCE_ARTIFACT_INACTIVE"

    const val EVIDENCE_CONTENT_UNAVAILABLE = "INFORMATION_REQUEST_EVIDENCE_CONTENT_UNAVAILABLE"

    const val EVIDENCE_PREVIEW_UNAVAILABLE = "INFORMATION_REQUEST_EVIDENCE_PREVIEW_UNAVAILABLE"

    const val EVIDENCE_CONTENT_QUARANTINED = "INFORMATION_REQUEST_EVIDENCE_CONTENT_QUARANTINED"

    const val EVIDENCE_CONTENT_NOT_RELEASED = "INFORMATION_REQUEST_EVIDENCE_CONTENT_NOT_RELEASED"

    const val EVIDENCE_UPLOAD_UNAVAILABLE = "INFORMATION_REQUEST_EVIDENCE_UPLOAD_UNAVAILABLE"

    const val EVIDENCE_UPLOAD_LIMIT_EXCEEDED = "INFORMATION_REQUEST_EVIDENCE_UPLOAD_LIMIT_EXCEEDED"

    const val EVIDENCE_POLICY_REFUSED = "INFORMATION_REQUEST_EVIDENCE_POLICY_REFUSED"

    const val EVIDENCE_DUPLICATE_CONTENT = "INFORMATION_REQUEST_EVIDENCE_DUPLICATE_CONTENT"

    const val SUBMISSION_STAGE_UNKNOWN = "INFORMATION_REQUEST_SUBMISSION_STAGE_UNKNOWN"

    const val SUBMISSION_LOCKED = "INFORMATION_REQUEST_SUBMISSION_LOCKED"

    const val SUBMISSION_ALREADY_SUBMITTED = "INFORMATION_REQUEST_SUBMISSION_ALREADY_SUBMITTED"

    const val SUBMISSION_STAGE_ORDER = "INFORMATION_REQUEST_SUBMISSION_STAGE_ORDER"

    const val SUBMISSION_INCOMPLETE = "INFORMATION_REQUEST_SUBMISSION_INCOMPLETE"

    const val SUBMISSION_NOT_WITHDRAWABLE = "INFORMATION_REQUEST_SUBMISSION_NOT_WITHDRAWABLE"

    const val ATTESTATION_NOT_AN_ASSERTION = "INFORMATION_REQUEST_ATTESTATION_NOT_AN_ASSERTION"

    const val ATTESTATION_PARTY_NOT_ELIGIBLE = "INFORMATION_REQUEST_ATTESTATION_PARTY_NOT_ELIGIBLE"

    const val ATTESTATION_PARTY_AMBIGUOUS = "INFORMATION_REQUEST_ATTESTATION_PARTY_AMBIGUOUS"

    const val ATTESTATION_STRENGTH_INSUFFICIENT = "INFORMATION_REQUEST_ATTESTATION_STRENGTH_INSUFFICIENT"

    const val ATTESTATION_SIGNATURE_REFERENCE_REQUIRED = "INFORMATION_REQUEST_ATTESTATION_SIGNATURE_REFERENCE_REQUIRED"

    const val ATTESTATION_SIGNATURE_REFERENCE_NOT_ACCEPTED =
        "INFORMATION_REQUEST_ATTESTATION_SIGNATURE_REFERENCE_NOT_ACCEPTED"

    const val ATTESTATION_ORDER_UNMET = "INFORMATION_REQUEST_ATTESTATION_ORDER_UNMET"

    const val ATTESTATION_REFUSAL_REASON_INVALID = "INFORMATION_REQUEST_ATTESTATION_REFUSAL_REASON_INVALID"

    const val AMENDMENT_TARGET_INVALID = "INFORMATION_REQUEST_AMENDMENT_TARGET_INVALID"

    const val AMENDMENT_SCHEMA_CHANGED = "INFORMATION_REQUEST_AMENDMENT_SCHEMA_CHANGED"

    const val AMENDMENT_OCCURRENCE_STRUCTURE_CHANGED = "INFORMATION_REQUEST_AMENDMENT_OCCURRENCE_STRUCTURE_CHANGED"

    const val AMENDMENT_SUBMITTED_SCOPE_CHANGED = "INFORMATION_REQUEST_AMENDMENT_SUBMITTED_SCOPE_CHANGED"

    const val SUCCESSOR_SOURCE_INVALID = "INFORMATION_REQUEST_SUCCESSOR_SOURCE_INVALID"

    const val RECURRENCE_NOT_DUE = "INFORMATION_REQUEST_RECURRENCE_NOT_DUE"
    ...
    fun allCodes(): List<String> = listOf(
        ...
        EVIDENCE_ARTIFACT_INACTIVE,
        EVIDENCE_CONTENT_UNAVAILABLE,
        EVIDENCE_PREVIEW_UNAVAILABLE,
        EVIDENCE_CONTENT_QUARANTINED,
        EVIDENCE_CONTENT_NOT_RELEASED,
        EVIDENCE_UPLOAD_UNAVAILABLE,
        EVIDENCE_UPLOAD_LIMIT_EXCEEDED,
        EVIDENCE_POLICY_REFUSED,
        EVIDENCE_DUPLICATE_CONTENT,
        SUBMISSION_STAGE_UNKNOWN,
        SUBMISSION_LOCKED,
        SUBMISSION_ALREADY_SUBMITTED,
        SUBMISSION_STAGE_ORDER,
        SUBMISSION_INCOMPLETE,
        SUBMISSION_NOT_WITHDRAWABLE,
        ATTESTATION_NOT_AN_ASSERTION,
        ATTESTATION_PARTY_NOT_ELIGIBLE,
        ATTESTATION_PARTY_AMBIGUOUS,
        ATTESTATION_STRENGTH_INSUFFICIENT,
        ATTESTATION_SIGNATURE_REFERENCE_REQUIRED,
        ATTESTATION_SIGNATURE_REFERENCE_NOT_ACCEPTED,
        ATTESTATION_ORDER_UNMET,
        ATTESTATION_REFUSAL_REASON_INVALID,
        AMENDMENT_TARGET_INVALID,
        AMENDMENT_SCHEMA_CHANGED,
        AMENDMENT_OCCURRENCE_STRUCTURE_CHANGED,
        AMENDMENT_SUBMITTED_SCOPE_CHANGED,
        SUCCESSOR_SOURCE_INVALID,
        RECURRENCE_NOT_DUE,
    )
}
