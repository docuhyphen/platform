...
object StepUpActionLabelFormatter
{
    private val actionLabels: Map<String, String> = mapOf(
        ...
        "PLATFORM_USER_SUBSCRIPTION_TRIAL_END" to "end a user subscription trial",
        "PLATFORM_USER_SUBSCRIPTION_TRIAL_CONVERT" to "convert a user trial to a paid subscription",
        "PLATFORM_ORG_SUBSCRIPTION_TRIAL_END" to "end an organization subscription trial",
