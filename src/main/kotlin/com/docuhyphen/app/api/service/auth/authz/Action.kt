...
enum class Action(val required: Capability)
{
    ...
    EXCHANGE_ACCEPT(Capability.EXCHANGE_ACCEPT),
    EXCHANGE_MANAGE_SCHEMA(Capability.EXCHANGE_ADMIN),

    // Organization trust
    ORG_TRUST_VIEW(Capability.ORG_TRUST_READ),
    ORG_TRUST_REQUEST(Capability.ORG_TRUST_REQUEST),
    ORG_TRUST_DECIDE(Capability.ORG_TRUST_DECIDE),
    ORG_TRUST_MANAGE_POLICY(Capability.ORG_TRUST_POLICY_MANAGE),
    ORG_TRUST_SUSPEND(Capability.ORG_TRUST_SUSPEND),
    EXTERNAL_IDENTITY_RESOLVE(Capability.EXTERNAL_IDENTITY_RESOLVE),
    EXTERNAL_GROUP_DISCOVER(Capability.EXTERNAL_GROUP_DISCOVER),
    ...
    INFORMATION_REQUEST_TEMPLATE_VIEW(Capability.INFORMATION_REQUEST_TEMPLATE_READ),
    INFORMATION_REQUEST_TEMPLATE_EDIT(Capability.INFORMATION_REQUEST_TEMPLATE_WRITE),

    // Runtime Information Request aggregate
    INFORMATION_REQUEST_CREATE(Capability.INFORMATION_REQUEST_CREATE),
    INFORMATION_REQUEST_VIEW(Capability.INFORMATION_REQUEST_READ),
    INFORMATION_REQUEST_EDIT(Capability.INFORMATION_REQUEST_WRITE),
    INFORMATION_REQUEST_AMEND(Capability.INFORMATION_REQUEST_WRITE),
    INFORMATION_REQUEST_ISSUE(Capability.INFORMATION_REQUEST_ISSUE),
    INFORMATION_REQUEST_CANCEL(Capability.INFORMATION_REQUEST_CANCEL),
    INFORMATION_REQUEST_SUPERSEDE(Capability.INFORMATION_REQUEST_ADMIN),
    ...
    INFORMATION_REQUEST_REQUIREMENT_VIEW(Capability.INFORMATION_REQUEST_READ),
    INFORMATION_REQUEST_REQUIREMENT_RESPOND(Capability.INFORMATION_REQUEST_RESPOND),
    INFORMATION_REQUEST_REQUIREMENT_ATTEST(Capability.INFORMATION_REQUEST_ATTEST),
    INFORMATION_REQUEST_REQUIREMENT_REVIEW(Capability.INFORMATION_REQUEST_REVIEW),
    INFORMATION_REQUEST_SUBMIT(Capability.INFORMATION_REQUEST_SUBMIT),
    INFORMATION_REQUEST_EVIDENCE_VIEW(Capability.INFORMATION_REQUEST_EVIDENCE_READ),
    INFORMATION_REQUEST_EVIDENCE_UPLOAD(Capability.INFORMATION_REQUEST_EVIDENCE_WRITE),
    INFORMATION_REQUEST_EVIDENCE_WITHDRAW(Capability.INFORMATION_REQUEST_EVIDENCE_WRITE),
    INFORMATION_REQUEST_EVIDENCE_MANAGE(Capability.INFORMATION_REQUEST_EVIDENCE_ADMIN),
    ...
    AUDIT_ENGAGEMENT_MANAGE(Capability.AUDIT_ENGAGEMENT_MANAGE),
}
