...
/**
 * Durable, transactional record of a domain event. Written by
 * [com.docuhyphen.app.api.service.notification.DomainEventOutboxPublisher] in the same transaction
 * as the authoritative state mutation that produced it, so the event intent survives a crash
 * between the state commit and event routing. A background dispatcher claims committed rows after
