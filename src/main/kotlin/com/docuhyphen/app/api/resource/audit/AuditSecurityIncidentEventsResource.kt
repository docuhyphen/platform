...
@Path("/auth/security-incidents/audit-events")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
class AuditSecurityIncidentEventsResource @Inject constructor(
...
)
{
    ...
    fun listSecurityIncidentAreaEvents(
        ...
        val page = auditSearchProjectionService.listSecurityIncidentAreaEvents(
            actor = actor,
