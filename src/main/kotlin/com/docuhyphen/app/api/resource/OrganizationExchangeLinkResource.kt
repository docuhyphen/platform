...
import com.docuhyphen.app.api.service.organization.OrganizationExchangeLinkService
...
class OrganizationExchangeLinkResource @Inject constructor(
    private val linkService: OrganizationExchangeLinkService,
...
)
{
    companion object
    {
        private val logger = LoggerFactory.getLogger(OrganizationExchangeLinkResource::class.java)
    }
