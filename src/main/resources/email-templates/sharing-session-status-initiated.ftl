...
<p style="margin:0 0 14px 0;"><strong>You received a new sharing request and your response is required.</strong></p>
...
<p style="margin:0 0 14px 0;">Open the session to accept or reject: <a href="${sessionLink}" style="color:#1f73b7;">${sessionLink}</a></p>
