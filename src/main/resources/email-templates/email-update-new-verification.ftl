<#assign emailTitle = (appName!'DocuHyphen') + " - Verify Your New Email">
<#include "email-header.ftl">

<p style="margin:0 0 14px 0;"><strong>Verify your new email address.</strong></p>
<p style="margin:0 0 14px 0;">Your current email has been verified. To finish moving your account to <strong>${newEmail}</strong>, enter the verification code below:</p>
...
<p style="margin:0 0 14px 0;">If you did not request this change, ignore this email and contact support immediately.</p>
