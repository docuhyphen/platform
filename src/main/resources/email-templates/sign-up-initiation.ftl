...
<p style="margin:0 0 14px 0;">Thank you for signing up. Use the verification code below to continue:</p>
...
<p style="margin:0 0 14px 0;">If you did not request this sign up, please ignore this email or contact support.</p>
