...
<p style="margin:0 0 14px 0;"><strong>The recipient rejected your sharing request.</strong></p>
<#else>
<p style="margin:0 0 14px 0;"><strong>You rejected this sharing request.</strong></p>
</#if>
