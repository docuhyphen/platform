<#assign emailTitle = (appName!'DocuHyphen') + " - Exchange Rescinded">
<#include "email-header.ftl">

<#if audience == "INITIATOR">
<p style="margin:0 0 14px 0;"><strong>Your exchange has been rescinded and moved to archive.</strong></p>
<#else>
<p style="margin:0 0 14px 0;"><strong>This exchange has been rescinded by the sender and moved to archive.</strong></p>
</#if>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 0 14px 0; border:1px solid #dddddd; background-color:#f0f2f5;">
    <tr>
        <td style="padding:12px 20px;">
            ...
            <p style="margin:6px 0 0 0;"><strong>Rescinded at:</strong> ${endedAt!'Not available'}</p>
        </td>
    </tr>
</table>

<p style="margin:0 0 14px 0;">Further document updates are no longer available for this exchange.</p>
