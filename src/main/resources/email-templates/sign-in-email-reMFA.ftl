<#assign emailTitle = (appName!'DocuHyphen') + " - Sign In Verification Code Resend">
<#include "email-header.ftl">

<p style="margin:0 0 14px 0;"><strong>You requested a new sign-in verification code.</strong></p>
