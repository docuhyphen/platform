<#assign emailTitle = (appName!'DocuHyphen') + " - Verification Required">
<#include "email-header.ftl">

<p style="margin:0 0 14px 0;">To <strong>${actionDescription!'complete this action'}</strong>, please use the verification code below.</p>

<p style="margin:0 0 14px 0;"><strong>Your verification code is:</strong></p>
...
<p style="margin:0 0 14px 0;">If you did not request this, please ignore this email and secure your account.</p>
