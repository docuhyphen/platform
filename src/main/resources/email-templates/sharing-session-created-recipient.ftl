...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 0 14px 0; border:1px solid #f5a623; background-color:#fff8ee;">
    <tr>
        <td style="padding:12px 20px;">
            ...
            <p style="margin:0 0 8px 0;">The sender has requested that you sign in to ${appName!'DocuHyphen'} to view and respond to this document request. If you don&apos;t have an account yet, you can create one for free.</p>
            <p style="margin:0;">
...
<p style="margin:0 0 14px 0;">Already have an account? <a href="${sessionLink}" style="color:#1f73b7;">Sign in and open the session</a>.</p>
<#else>
