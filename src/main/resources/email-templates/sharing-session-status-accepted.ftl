<#assign emailTitle = (appName!'DocuHyphen') + " - Sharing Request Accepted">
<#include "email-header.ftl">

<#if audience == "INITIATOR">
<p style="margin:0 0 14px 0;"><strong>Great news: the recipient accepted your sharing request.</strong></p>
<#else>
<p style="margin:0 0 14px 0;"><strong>You accepted this sharing request. The session is now active.</strong></p>
</#if>
