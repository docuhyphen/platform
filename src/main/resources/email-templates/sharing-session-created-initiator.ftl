<#assign emailTitle = (appName!'DocuHyphen') + " - Document Request Sent">
<#include "email-header.ftl">

<p style="margin:0 0 14px 0;"><strong>Your document request has been sent.</strong></p>
...
<p style="margin:0 0 14px 0;">View the session: <a href="${sessionLink}" style="color:#1f73b7;">${sessionLink}</a></p>
